...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        LocalTime timeOnFriday = LocalTime.of(21, 59);
        LocalTime timeOnSaturday = LocalTime.of(23,0);

        return (day == DayOfWeek.FRIDAY && time.isAfter(timeOnFriday))
                || (day == DayOfWeek.SATURDAY)
                || (day == DayOfWeek.SUNDAY && time.isBefore(timeOnSaturday));
    }
}
